...
lesson_germain_4 = Lesson.create!(teacher: germain, name: "Intégrales", topic: "Mathématiques", subtopic: "Définition de l’intégrale et calcul de la valeur moyenne d’une fonction sur un intervalle", min_num_of_participants: 3, max_num_of_participants: 10, price: 20, current_price: 20, price_per_user: 20, grade: "Première", summary: "Résolution graphique d’une équation.",description: "Nous utilisons la règle des signes pour trouver le signe d’un produit ou d’un quotient :", duration: 13, starts_at: "13:00", date: "2018-12-21")
...
lesson_damien_3 = Lesson.create!(teacher: damien, name: "Le réflexe myotatique", topic: "SVT", subtopic: "Biologie", min_num_of_participants: 3, max_num_of_participants: 10, price: 30, current_price: 30, price_per_user: 30, grade: "Terminale", summary: "Le réflexe myotatique déclenche une contraction d’un muscle en réponse à son propre étirement. Il permet le maintien des postures dans l’espace en assurant une contraction légère des muscles, il s’agit du tonus musculaire. Il intervient également dans le rétablissement de notre position suite à un déséquilibre, afin d’éviter une chute par exemple.", description: "Elevé dans le cadre d’une culture (destinée à produire de la biomasse végétale) Maxime autem labore ullam temporibus animi necessitatibus et dolores incidunt totam.", duration: 60, starts_at: "13:00", date: "2018-12-11")
