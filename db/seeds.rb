...
lesson_anna_1 = Lesson.create!(teacher: anna, name: "Triangle rectangle", topic: "Mathématiques", subtopic: "Trigonométrie", min_num_of_participants: 4, max_num_of_participants: 6, price: 50, current_price: 50, price_per_user: 50, grade: "Terminale", summary: "Dans un triangle rectangle, on définit trois côtés : l'hypoténuse, le côté adjacent, le côté opposé à l’angle étudié.", description: "Attention, seule l'hypoténuse est toujours la même quel que soit l’angle étudié. Le côté opposé à l’angle {ABC} ABC est [AC][AC], mais le côté opposé à l’angle {ACB} ACB est [AB][AB].", duration: 60, starts_at: "12:00", date: "2019-04-11")
...
lesson_anna_2 = Lesson.create!(teacher: anna, name: "Calcul de longueurs et d'angles", topic: "Mathématiques", subtopic: "Trigonométrie", min_num_of_participants: 4, max_num_of_participants: 6, price: 40, current_price: 40, price_per_user: 40, grade: "Terminale", summary: "Dans un triangle rectangle, on définit trois côtés : l'hypoténuse, le côté adjacent, le côté opposé à l’angle étudié.", description: "Attention, seule l'hypoténuse est toujours la même quel que soit l’angle étudié. Le côté opposé à l’angle {ABC} ABC est [AC][AC], mais le côté opposé à l’angle {ACB} ACB est [AB][AB].", duration: 60, starts_at: "19:00", date: "2019-04-17")
...
lesson_germain = Lesson.create!(teacher: germain, name: "Univers et probabilités", topic: "Mathématiques", subtopic: "Probabilités", min_num_of_participants: 3, max_num_of_participants: 10, price: 100, current_price: 100, price_per_user: 100, grade: "Première", summary: "Soit OmegaΩ l’ensemble des éventualités (résultats) possibles d’une expérience aléatoire. On appelle OmegaΩ l’univers de l’expérience.", description: "On appelle évènement toute sous partie de OmegaΩ.", duration: 60, starts_at: "07:00", date: "2019-04-12")
...
lesson_edward_3 = Lesson.create!(teacher: edward, name: "La princesse de Clèves", topic: "Français", subtopic: "Roman", min_num_of_participants: 4, max_num_of_participants: 6, price: 25, current_price: 25, price_per_user: 25, grade: "Terminale", summary: "Les places étaient attribuées en fonction de la classe sociale : les premiers rangs étaient réservés aux citoyens importants", description: "Les places étaient attribuées en fonction de la classe sociale : les premiers rangs étaient réservés aux citoyens importants", duration: 60, starts_at: "14:00", date: "2019-05-11")
...
lesson_edward_4 = Lesson.create!(teacher: edward, name: "Le Romantisme", topic: "Français", subtopic: "Mouvements littéraires", min_num_of_participants: 3, max_num_of_participants: 10, price: 30, current_price: 30, price_per_user: 30, grade: "Première", summary: "La Pléiade est un groupe de 7 poètes français de la Renaissance (XVIème siècle). Ces poètes veulent renouveler la langue française, et refuse d'autres idiomes alors plus nobles comme le latin.La Pléiade se caractérise également par son admiration de la littérature antique.", description: "Les places étaient attribuées en fonction de la classe sociale : les premiers rangs étaient réservés aux citoyens importants", duration: 60, starts_at: "10:00", date: "2019-05-16")
...
lesson_damien_3 = Lesson.create!(teacher: damien, name: "Le réflexe myotatique", topic: "SVT", subtopic: "Corps humain", min_num_of_participants: 3, max_num_of_participants: 10, price: 30, current_price: 30, price_per_user: 30, grade: "Terminale", summary: "Le réflexe myotatique déclenche une contraction d’un muscle en réponse à son propre étirement. Il permet le maintien des postures dans l’espace en assurant une contraction légère des muscles, il s’agit du tonus musculaire.", description: "Elevé dans le cadre d’une culture (destinée à produire de la biomasse végétale) Maxime autem labore ullam temporibus animi necessitatibus et dolores incidunt totam.", duration: 60, starts_at: "13:00", date: "2019-05-11")
